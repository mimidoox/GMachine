...
//		ss.delete(ss.findById(1));
	...
	//ms.create(new Machine("PO48", "HP", 10000, new Date(), ss.findById(2)));
...
//		ms.create(new Machine("CC45", "Deel", 9000, new Date(), ss.findById(3)));
	...
	System.out.println(ms.selectMachines(new Date("2022/11/16"), new Date("2022/11/17")));
	System.out.println(ms.selectMachinesSalle(ss.findById(3)));
